...
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F446xE/TARGET_NUCLEO_F446ZE/PeripheralPins.o
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F446xE/TARGET_NUCLEO_F446ZE/system_clock.o
...
INCLUDE_PATHS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F446xE/TARGET_NUCLEO_F446ZE
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1634055773.9696357
...
C_FLAGS += -DTARGET_NAME=NUCLEO_F446ZE
...
C_FLAGS += -O0 # Os for prod O0 for debug
C_FLAGS += -g
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1634055773.9696357
...
CXX_FLAGS += -DTARGET_NAME=NUCLEO_F446ZE
...
CXX_FLAGS += -O0 # Os for prod O0 for debug
CXX_FLAGS += -g
...
ASM_FLAGS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F446xE/TARGET_NUCLEO_F446ZE
...
ASM_FLAGS += -O0 # Os for prod O0 for debug
ASM_FLAGS += -g
